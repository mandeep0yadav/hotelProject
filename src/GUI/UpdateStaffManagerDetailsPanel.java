...
import listeners.UpdateStaffManagerDetailsListeners;
 ...
 */
public class UpdateStaffManagerDetailsPanel{



        private JPanel updateStaffManagerDetailsPanel;
        ...
        // Listeners
        private UpdateStaffManagerDetailsListeners updateStaffManagerDetailsListeners;

        // Constructor
        public UpdateStaffManagerDetailsPanel() {

            System.out.println("Creating Register Panel...");

            updateStaffManagerDetailsPanel = new JPanel();
            ...
            updateStaffManagerDetailsListeners = new UpdateStaffManagerDetailsListeners();
        ...
        private void setProperty() {
            ...
            updateStaffManagerDetailsPanel.setLayout(null);
            updateStaffManagerDetailsPanel.setOpaque(false);
        ...
        private void setBounds() {
            ...
            updateStaffManagerDetailsPanel.setBounds(0,140,1000,550);
        ...
        private void addComponentToPanel() {
            ...
            updateStaffManagerDetailsPanel.add(personalLabel);
            updateStaffManagerDetailsPanel.add(personalLabelSeparator);

            updateStaffManagerDetailsPanel.add(firstNameLabel);
            updateStaffManagerDetailsPanel.add(lastNameLabel);
            updateStaffManagerDetailsPanel.add(genderLabel);
            updateStaffManagerDetailsPanel.add(dobLabel);
            updateStaffManagerDetailsPanel.add(phoneLabel);
            updateStaffManagerDetailsPanel.add(emailLabel);
            updateStaffManagerDetailsPanel.add(housenumberLabel);
            updateStaffManagerDetailsPanel.add(streetAddressLabel);
            updateStaffManagerDetailsPanel.add(countryLabel);
            updateStaffManagerDetailsPanel.add(cityLabel);
            updateStaffManagerDetailsPanel.add(postalCodeLabel);

            updateStaffManagerDetailsPanel.add(loginLabel);
            updateStaffManagerDetailsPanel.add(loginLabelSeparator);
            updateStaffManagerDetailsPanel.add(empIDLabel);
            updateStaffManagerDetailsPanel.add(passwordLabel);

            updateStaffManagerDetailsPanel.add(jobLabel);
            updateStaffManagerDetailsPanel.add(jobLabelSeparator);
            updateStaffManagerDetailsPanel.add(postLabel);
            updateStaffManagerDetailsPanel.add(salaryLabel);

            // Adding all fields to Panel
            updateStaffManagerDetailsPanel.add(editFirstName);
            updateStaffManagerDetailsPanel.add(editLastName);
            updateStaffManagerDetailsPanel.add(genderList);

            updateStaffManagerDetailsPanel.add(dobDayList);
            updateStaffManagerDetailsPanel.add(dobMonthList);
            updateStaffManagerDetailsPanel.add(dobYearList);

            updateStaffManagerDetailsPanel.add(editPhone);
            updateStaffManagerDetailsPanel.add(editEmail);
            updateStaffManagerDetailsPanel.add(edithouseNumber);
            updateStaffManagerDetailsPanel.add(editStreetAddress);
            updateStaffManagerDetailsPanel.add(editCountry);
            updateStaffManagerDetailsPanel.add(editCity);
            updateStaffManagerDetailsPanel.add(editPostalCode);
            updateStaffManagerDetailsPanel.add(editEmpID);
            updateStaffManagerDetailsPanel.add(editPassword);
            updateStaffManagerDetailsPanel.add(postList);
            updateStaffManagerDetailsPanel.add(editSalary);
            updateStaffManagerDetailsPanel.add(updateButton);


        }

        public JPanel getUpdateStaffManagerDetailsPanel() {
            return this.updateStaffManagerDetailsPanel;
        }

        private void addListeners() {
            updateStaffManagerDetailsListeners.updateButtonListener(updateButton);
        }
