...
import listeners.AddStaffManagerPanelListeners;
...
public class AddStaffManagerPanel {
    ...
    private JPanel addStaffManagerPanel;
    ...
    // Listeners
    private AddStaffManagerPanelListeners addStaffManagerPanelListeners;


    // Constructor
    public AddStaffManagerPanel() {

        System.out.println("Creating Register Panel...");

        addStaffManagerPanel = new JPanel();
        ...
        addStaffManagerPanelListeners = new AddStaffManagerPanelListeners();
    ...
    private void setProperty() {
        ...
        addStaffManagerPanel.setLayout(null);
        addStaffManagerPanel.setOpaque(false);
    ...
    private void setBounds() {
        ...
        addStaffManagerPanel.setBounds(0,140,1000,550);
    ...
    private void addComponentToPanel() {
        ...
        addStaffManagerPanel.add(addStaffLabel);


        addStaffManagerPanel.add(personalLabel);
        addStaffManagerPanel.add(personalLabelSeparator);

        addStaffManagerPanel.add(firstNameLabel);
        addStaffManagerPanel.add(lastNameLabel);
        addStaffManagerPanel.add(genderLabel);
        addStaffManagerPanel.add(dobLabel);
        addStaffManagerPanel.add(phoneLabel);
        addStaffManagerPanel.add(emailLabel);
        addStaffManagerPanel.add(housenumberLabel);
        addStaffManagerPanel.add(streetAddressLabel);
        addStaffManagerPanel.add(countryLabel);
        addStaffManagerPanel.add(cityLabel);
        addStaffManagerPanel.add(postalCodeLabel);

        addStaffManagerPanel.add(loginLabel);
        addStaffManagerPanel.add(loginLabelSeparator);
        addStaffManagerPanel.add(empIDLabel);
        addStaffManagerPanel.add(passwordLabel);

        addStaffManagerPanel.add(jobLabel);
        addStaffManagerPanel.add(jobLabelSeparator);
        addStaffManagerPanel.add(postLabel);
        addStaffManagerPanel.add(salaryLabel);

        // Adding all fields to Panel
        addStaffManagerPanel.add(editFirstName);
        addStaffManagerPanel.add(editLastName);
        addStaffManagerPanel.add(genderList);

        addStaffManagerPanel.add(dobDayList);
        addStaffManagerPanel.add(dobMonthList);
        addStaffManagerPanel.add(dobYearList);

        addStaffManagerPanel.add(editPhone);
        addStaffManagerPanel.add(editEmail);
        addStaffManagerPanel.add(editStreetAddress);
        addStaffManagerPanel.add(edithouseNumber);
        addStaffManagerPanel.add(editCountry);
        addStaffManagerPanel.add(editCity);
        addStaffManagerPanel.add(editPostalCode);
        addStaffManagerPanel.add(editEmpID);
        addStaffManagerPanel.add(editPassword);
        addStaffManagerPanel.add(postList);
        addStaffManagerPanel.add(editSalary);
        addStaffManagerPanel.add(registerButton);

    }

    private void addListeners() {

        addStaffManagerPanelListeners.addStaffButtonListener(registerButton);

    }

    public void destroy() {
        addStaffManagerPanel.setVisible(false);
        System.out.println("Register Panel destroyed...");
    }

    public JPanel getAddStaffManagerPanel() {
        return this.addStaffManagerPanel;
    }
